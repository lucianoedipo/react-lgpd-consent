...
import { useConsent, useOpenPreferencesModal, _registerGlobalOpenPreferences, _unregisterGlobalOpenPreferences, openPreferencesModal } from './useConsent';
...
describe('useOpenPreferencesModal', () => {
  it('should throw an error when used outside of ConsentProvider', () => {
    ...
    }).toThrow('[LGPD-CONSENT] useOpenPreferencesModal deve ser usado dentro do ConsentProvider. Envolva seu componente com <ConsentProvider>.');

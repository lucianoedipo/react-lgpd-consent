...
describe('discoverRuntimeCookies', () => {
  ...
  it('should return a list of cookies', () => {
    mockCookie('_ga=GA1.2.12345.67890; _gid=GA1.2.98765.43210; cookieConsent={"preferences":{"analytics":true}}');
...
describe('detectConsentCookieName', () => {
  ...
  it('should return the name of the consent cookie', () => {
    mockCookie('_ga=GA1.2.12345.67890; my-consent-cookie={"preferences":{"analytics":true},"version":"1"}; _gid=GA1.2.98765.43210');
